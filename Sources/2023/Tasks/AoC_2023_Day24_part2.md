...
You can use the probably-magical winds to reach **any integer position** you like and to propel the rock at **any integer velocity**. Now **including the Z axis** in your calculations, if you throw the rock at time `0`, where do you need to be so that the rock **perfectly collides with every hailstone**? Due to probably-magical inertia<!--- What, you've never studied probably-magical physics? -->, the rock won't slow down or change direction when it collides with a hailstone.
