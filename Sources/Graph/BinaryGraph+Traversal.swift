...
public struct BinaryGraphTraversal<Graph: BinaryGraphProtocol, Strategy: BinaryGraphTraversalStrategy>: Sequence where Graph.Node == Strategy.Node, Graph.Edge == Strategy.Edge {
