...
struct SearchStrategy {
    ...
    @Test func shortestPathGrid() {
        ...
        #expect(
            graph.shortestPath(
                ...
                using: .dijkstra()
            )?.path.map(\.value) == ["A", "B", "G", "L", "Q", "V", "W", "X", "Y"]
        )
        ...
        #expect(
            graph.shortestPath(
                from: GridPosition(x: 0, y: 0),
                to: GridPosition(x: 4, y: 4),
                using: .aStar(heuristic: .eucledianDistance(of: \.position.coordinates))
            )?.path.map(\.value) == ["A", "B", "G", "L", "Q", "V", "W", "X", "Y"]
        )
    ...
    @Test func shortestPaths() {
        let smaller = GridGraph(grid: [[1, 2, 3], [4, 5, 6], [7, 8, 9]]).weightedByDistance()
        #expect(
            Set(smaller.shortestPaths(from: GridPosition(x: 0, y: 0)).map { $0.value.path.map(\.value) }) == [
                [1],
                [1, 2],
                [1, 5, 3],
                [1, 4],
...
//        #expect(graph.minimumCut(from: "S", to: "T", using: .fordFulkerson()).cutEdges.sortedDescription() == ["A-S", "B-S"])
    ...
    @Test func hamiltonianPath() {
        ...
        #expect(small.hamiltonianPath(from: .init(position: GridPosition(x: 0, y: 0), value: "A"))?.path.map(\.value) == ["A", "B", "D", "C"])
        #expect(small.hamiltonianCycle(from: .init(position: GridPosition(x: 0, y: 0), value: "A"))?.path.map(\.value) == ["A", "B", "D", "C", "A"])

        #expect(small.hamiltonianPath(from: .init(position: GridPosition(x: 0, y: 0), value: "A"), using: .heuristic(.degree()))?.path.map(\.value) == ["A", "B", "D", "C"])
        #expect(small.hamiltonianCycle(from: .init(position: GridPosition(x: 0, y: 0), value: "A"), using: .heuristic(.degree()))?.path.map(\.value) == ["A", "B", "D", "C", "A"])
        ...
        #expect(large.hamiltonianPath()?.path.map(\.value) == ["A", "B", "C", "D", "H", "L", "P", "O", "N", "M", "I", "J", "K", "G", "F", "E"])
        #expect(large.hamiltonianPath(from: .init(position: GridPosition(x: 0, y: 0), value: "A"))?.path.map(\.value) == ["A", "B", "C", "D", "H", "L", "P", "O", "N", "M", "I", "J", "K", "G", "F", "E"])
        #expect(large.hamiltonianPath(from: .init(position: GridPosition(x: 0, y: 0), value: "A"), to: .init(position: GridPosition(x: 3, y: 0), value: "D"))?.path.map(\.value) == ["A", "B", "C", "D", "H", "L", "P", "O", "N", "M", "I", "J", "K", "G", "F", "E"])

        #expect(large.hamiltonianCycle()?.path.map(\.value) == ["A", "B", "C", "D", "H", "L", "P", "O", "N", "M", "I", "J", "K", "G", "F", "E", "A"])
        #expect(large.hamiltonianCycle(from: .init(position: GridPosition(x: 1, y: 1), value: "F"))?.path.map(\.value) == ["F", "G", "H", "D", "C", "B", "A", "E", "I", "M", "N", "O", "P", "L", "K", "J", "F"])

        #expect(large.hamiltonianPath(using: .heuristic(.degree()))?.path.map(\.value) == ["A", "B", "F", "E", "I", "M", "N", "J", "K", "O", "P", "L", "H", "G", "C", "D"])
        #expect(large.hamiltonianPath(from: .init(position: GridPosition(x: 0, y: 0), value: "A"), using: .heuristic(.degree()))?.path.map(\.value) == ["A", "B", "F", "E", "I", "M", "N", "J", "K", "O", "P", "L", "H", "G", "C", "D"])
        #expect(large.hamiltonianPath(from: .init(position: GridPosition(x: 0, y: 0), value: "A"), to: .init(position: GridPosition(x: 3, y: 0), value: "D"), using: .heuristic(.degree()))?.path.map(\.value) == ["A", "B", "F", "E", "I", "M", "N", "J", "K", "O", "P", "L", "H", "G", "C", "D"])

        #expect(large.hamiltonianCycle(using: .heuristic(.degree()))?.path.map(\.value) == ["A", "B", "F", "G", "C", "D", "H", "L", "P", "O", "K", "J", "N", "M", "I", "E", "A"])
        #expect(large.hamiltonianCycle(from: .init(position: GridPosition(x: 1, y: 1), value: "F"), using: .heuristic(.degree()))?.path.map(\.value) == ["F", "J", "I", "M", "N", "O", "P", "L", "K", "G", "H", "D", "C", "B", "A", "E", "F"])
    }
