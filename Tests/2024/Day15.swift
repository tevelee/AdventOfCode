...
private struct Day15 {
    ...
    func part1_small() throws {
        ...
        <^^>>>vv<v>>v<<
        """)
        #expect(problem.solvePart1() == 2_028)
    }
    ...
    func part1_large() throws {
        ...
        """)
        #expect(problem.solvePart1() == 10_092)
    }
    ...
    func part2_small() throws {
        ...
        <vv<<^^<<^^
        """)
        #expect(problem.solvePart2() == 105 + 207 + 306)
    }
    ...
    func part2_large() throws {
        ...
        v^^>>><<^^<>>^v^<v^vv<>v^<<>^<^v^v><^<<<><<^<v><v<>vv>>v><v^<vv<>v^<<^
        """)
        #expect(problem.solvePart2() == 9_021)
    }

    @Suite(.tags(.live), .serialized)
    struct Day15Live: @unchecked Sendable {
        ...
        @Test("Day 15 Part 1")
        func part1() {
            #expect(problem.solvePart1() == 1_499_739)
        }
        
        @Test("Day 15 Part 2")
        func part2() {
            #expect(problem.solvePart2() == 1_522_215)
        }
    }
}
