...
final class AoC_2021_Tests: XCTestCase {
    ...
    func test_day1() async throws {
        let problem = try AoC_2021_Day1(url(for: "2021_day1"))
    ...
    func test_day2() async throws {
        let problem = try AoC_2021_Day2(url(for: "2021_day2"))
        let part1 = try await problem.solvePart1()
    ...
    func test_day3() async throws {
        let problem = try AoC_2021_Day3(url(for: "2021_day3"))
        let part1 = try await problem.solvePart1()
    ...
    func test_day4() throws {
        let problem = try AoC_2021_Day4(url(for: "2021_day4"))
        let part1 = try problem.solvePart1()
    ...
    func test_day5() async throws {
        let problem = try AoC_2021_Day5(url(for: "2021_day5"))
        let part1 = try await problem.solvePart1()
    ...
    func test_day6() throws {
        let problem = try AoC_2021_Day6(url(for: "2021_day6"))
    ...
    func test_day7() throws {
        let problem = try AoC_2021_Day7(url(for: "2021_day7"))
        let part1 = problem.solvePart1()
    ...
    func test_day8() async throws {
        let problem = try AoC_2021_Day8(url(for: "2021_day8"))
        let part1 = try await problem.solvePart1()
    ...
    func test_day9() async throws {
        let problem = try AoC_2021_Day9(url(for: "2021_day9"))
        let part1 = try await problem.solvePart1()
    ...
    func test_day10() async throws {
        let problem = try AoC_2021_Day10(url(for: "2021_day10"))
        let part1 = try await problem.solvePart1()
    ...
    func test_day11() throws {
        let problem = try AoC_2021_Day11(url(for: "2021_day11"))
        let part1 = problem.solvePart1()
    ...
    func test_day12() throws {
        let problem = try AoC_2021_Day12(url(for: "2021_day12"))
        let part1 = problem.solvePart1()
    ...
    func test_day13() throws {
        let problem = try AoC_2021_Day13(url(for: "2021_day13"))
        let part1 = problem.solvePart1()
    ...
    func test_day14() throws {
        let problem = try AoC_2021_Day14(url(for: "2021_day14"))
        let part1 = problem.solvePart1()
    ...
    func test_day15() throws {
        let problem = try AoC_2021_Day15(url(for: "2021_day15"))
        let part1 = problem.solvePart1()
    ...
    func test_day16() throws {
        let problem = try AoC_2021_Day16(url(for: "2021_day16"))
        let part1 = problem.solvePart1()
    ...
    func test_day17() throws {
        let problem = try AoC_2021_Day17(url(for: "2021_day17"))
        let part1 = problem.solvePart1()
    ...
    func test_day18() async throws {
        let problem = try AoC_2021_Day18(url(for: "2021_day18"))
        let part1 = try await problem.solvePart1()
    ...
    func test_day19() async throws {
        let problem = try AoC_2021_Day19(url(for: "2021_day19"))
        let part1 = try await problem.solvePart1()
    ...
    func test_day20() async throws {
        let problem = try AoC_2021_Day20(url(for: "2021_day20"))
        let part1 = try await problem.solvePart1()
    ...
    func test_day21() async throws {
        let problem = try AoC_2021_Day21(url(for: "2021_day21"))
        let part1 = try await problem.solvePart1()
        XCTAssertEqual(part1, 925605)
        print("Day21 / Part1 solution: \(part1)")
        let part2 = try await problem.solvePart2()
        XCTAssertEqual(part2, 486638407378784)
    ...
    func test_day22() async throws {
        let problem = try AoC_2021_Day22(url(for: "2021_day22"))
        let part1 = try await problem.solvePart1()
    ...
    func test_day23_intro() async throws {
        ...
        let part2 = try await problem.solvePart2()
        XCTAssertEqual(part2, 44169)
    }

    func test_day23() async throws {
        let problem = try AoC_2021_Day23(url(for: "2021_day23"))
        let part1 = try await problem.solvePart1()
        XCTAssertEqual(part1, 19160)
        print("Day21 / Part1 solution: \(part1)")
        let part2 = try await problem.solvePart2()
        XCTAssertEqual(part2, 47232)
        print("Day21 / Part2 solution: \(part2)")
    }

    func test_day24() async throws {
        let problem = try AoC_2021_Day24(url(for: "2021_day24"))
        let part1 = try await problem.solvePart1()
    ...
    func test_day25_intro() async throws {
        ...
        """)
        let part1 = try await problem.solvePart1()
        XCTAssertEqual(part1, 58)
        let part2 = try await problem.solvePart2()
        XCTAssertEqual(part2, 0)
    }

    func test_day25() async throws {
        let problem = try AoC_2021_Day25(url(for: "2021_day25"))
        let part1 = try await problem.solvePart1()
        XCTAssertEqual(part1, 321)
        print("Day21 / Part1 solution: \(part1)")
        let part2 = try await problem.solvePart2()
        XCTAssertEqual(part2, 0)
        print("Day21 / Part2 solution: \(part2)")
