...
public final class AoC_2021_Day17 {
    ...
    public init(_ input: String) {
        let parser = "target area: x="
            ...
            .take(Int.parser())
            .skip(End())
        let dimensions = parser.parse(input.trimmingCharacters(in: .newlines))!
        targetArea = TargetArea(x: dimensions.0 ... dimensions.1, y: dimensions.2 ... dimensions.3)
    }
